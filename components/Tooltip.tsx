  ...
  return (
    ...
    >
      ...
      {showTooltip && isTruncated && (
        <div className="absolute z-50 px-3 py-2 bg-neutral-600 text-white text-xs font-medium rounded-none shadow-xl whitespace-nowrap pointer-events-none bottom-full left-1/2 transform -translate-x-1/2 mb-2">
          {content}
          <div className="absolute top-full left-1/2 transform -translate-x-1/2 -mt-1">
            <div className="border-4 border-transparent border-t-neutral-600"></div>
          </div>
        </div>
      )}
    </div>
