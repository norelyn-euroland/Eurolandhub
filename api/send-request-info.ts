...
import { requestInfoTemplate, replaceTemplateVariables } from '../lib/email-templates.js';
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  // Replace variables in request info template
  const htmlContent = replaceTemplateVariables(requestInfoTemplate.html, {
    first_name: firstName || '',
  });

  const subject = replaceTemplateVariables(requestInfoTemplate.subject, {
    first_name: firstName || '',
  });
